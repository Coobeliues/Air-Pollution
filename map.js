...
function getMarkerPopup(markerUID) {
    const marker =  getMarkerAQI(markerUID);
...
function init() {
    ...
    const locations = {
        Almaty: "43.238949,76.889709,43.349389,77.144542",
    ...
    function addLocationButton(location, bounds) {
        ...
        button.classList.add("buttonMap");
